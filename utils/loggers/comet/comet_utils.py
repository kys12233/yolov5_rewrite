...
# print("logger的值是：",logger)
# exit()

try:
    import comet_ml
    #comet.ml是一个机器学习实验管理平台，可以记录和可视化你的实验数据和结果。 
    # 当你在运行Python程序时，如果使用了comet.ml库，它会尝试在程序结束时自动上传数据到平台上，
    # 但是如果没有正确配置或者没有上传权限，就会出现"comet unload"错误
